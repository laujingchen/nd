...
DEF(TOK2_VOID, "Void")
// MOD: `ret` is a variable in lib/libtcc1.c:556
DEF(TOK2_RET, "ret")
DEF(TOK2_PRIV, "priv")
DEF(TOK2_CONT, "cont")
...
DEF(TOK2_B32, "B32")
DEF(TOK2_B64, "B64")
// MOD: `type` is a struct member in win32/include/winapi/winuser.h:2445
DEF(TOK2_TYPE, "type")
DEF(TOK2_ALIGNOF, "alignof")
...
DEF(TOK2_DEF, "def")
// MOD TODO BUG: Having this declaration here causes "stdio.h:11: error: malformed #pragma directive"
//DEF(TOK2_INCL, "incl")
// MOD TODO BUG: `@` causes "error: identifier expected"
DEF(TOK2_DEFINED, "defd")
DEF(TOK2_ERR, "err")
DEF(TOK2_PRAG, "prag")
// MOD TODO: Done up to this point for now
DEF(TOK2__LINE, "_LINE")
DEF(TOK2__FILE, "_FILE")
DEF(TOK2__DATE, "_DATE")
DEF(TOK2__TIME, "_TIME")

/* special identifiers */
DEF(TOK___FUNC__, "__func__")

DEF(TOK2__FUNC, "_func")
