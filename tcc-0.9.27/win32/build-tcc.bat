...
@rem MOD: Compile libtcc using the installed TCC instead of the newly compiled one so that there won't be keyword conflicts
@rem MOD: Default is `.\tcc`
@rem MOD: Probably related: https://lists.nongnu.org/archive/html/tinycc-devel/2021-06/msg00041.html
@set CC2=\ljc\programs\tcc\tcc.exe
%CC2% -impdef libtcc.dll -o libtcc\libtcc.def
@if errorlevel 1 goto :the_end

:libtcc1.a
@set O1=libtcc1.o crt1.o crt1w.o wincrt1.o wincrt1w.o dllcrt1.o dllmain.o chkstk.o bcheck.o
%CC2% -m32 -c ../lib/libtcc1.c
%CC2% -m32 -c lib/crt1.c
%CC2% -m32 -c lib/crt1w.c
%CC2% -m32 -c lib/wincrt1.c
%CC2% -m32 -c lib/wincrt1w.c
%CC2% -m32 -c lib/dllcrt1.c
%CC2% -m32 -c lib/dllmain.c
%CC2% -m32 -c lib/chkstk.S
%CC2% -m32 -w -c ../lib/bcheck.c
%CC2% -m32 -c ../lib/alloca86.S
%CC2% -m32 -c ../lib/alloca86-bt.S
%CC2% -m32 -ar lib/libtcc1-32.a %O1% alloca86.o alloca86-bt.o
@if errorlevel 1 goto :the_end
%CC2% -m64 -c ../lib/libtcc1.c
%CC2% -m64 -c lib/crt1.c
%CC2% -m64 -c lib/crt1w.c
%CC2% -m64 -c lib/wincrt1.c
%CC2% -m64 -c lib/wincrt1w.c
%CC2% -m64 -c lib/dllcrt1.c
%CC2% -m64 -c lib/dllmain.c
%CC2% -m64 -c lib/chkstk.S
%CC2% -m64 -w -c ../lib/bcheck.c
%CC2% -m64 -c ../lib/alloca86_64.S
%CC2% -m64 -c ../lib/alloca86_64-bt.S
%CC2% -m64 -ar lib/libtcc1-64.a %O1% alloca86_64.o alloca86_64-bt.o
@if errorlevel 1 goto :the_end
